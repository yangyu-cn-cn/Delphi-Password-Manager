...
type
  TFrmOpenImg = class(TForm)
    ...
    procedure LbxDateiListItemClick(const Sender: TCustomListBox; const Item: TListBoxItem);
...
procedure TFrmOpenImg.LbxDateiListItemClick(const Sender: TCustomListBox; const Item: TListBoxItem);
begin
